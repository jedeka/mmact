...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    # NOTE: custom
        ...
        from lerobot.policies.mmact.modeling_mmact import mmACTPolicy
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    # NOTE: custom
    elif policy_type == "mmact":
        return mmACTConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, (ACTConfig, mmACTConfig)):
